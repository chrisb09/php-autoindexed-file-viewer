...
- **Temporary share-by-link** — generate unique, expiring links for files or folders that bypass basic authentication (requires Nginx configuration).
...
The translations in this project are also generated by AI, specifically using [Qwen 3 14B q8](https://lmstudio.ai/models/qwen/qwen3-14b), chosen for its impressive multilingual capabilities. Since I do not understand most of the languages myself, I had to rely entirely on the model's output for these.
